...
Runs all 11 pipeline steps → saves outputs to `output/{product}/` → offers Pinecone save → offers Google Drive upload.
...
- Output: `output/{product}/01_awareness.md`
...
- Output: `output/{product}/02_competitor.md`
...
- Output: `output/{product}/03_avatar.md`
...
- Also generate: `output/{product}/product-marketing-context.md` (shared context for all copy skills)
- Output: `output/{product}/04_master_doc.md` + `output/{product}/product-marketing-context.md`
...
- Output: `output/{product}/05_desire_extraction.md`
...
- Output: `output/{product}/06_desire_validation.md`
...
- Output: `output/{product}/09_marketing_angles.md`
...
- Output: `output/{product}/08_desire_testing_copy.md`
...
- Output: `output/{product}/10_angle_testing_copy.md`
...
- Output: `output/{product}/11a_advertorial.md`
...
- Output: `output/{product}/11b_advertorial.md`
